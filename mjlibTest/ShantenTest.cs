...
namespace mjlibTest
{
    ...
    public class ShantenTest
    {
        ...
        {
            var tiles = TileIds.Parse(man: "77", pin: "114477", sou: "114477");
            AreEqual(AGARI_STATE, CalculateShanten(tiles));

            tiles = TileIds.Parse(man: "76", pin: "114477", sou: "114477");
            AreEqual(0, CalculateShanten(tiles));

            tiles = TileIds.Parse(man: "76", pin: "114479", sou: "114477");
            AreEqual(1, CalculateShanten(tiles));

            tiles = TileIds.Parse(man: "76", pin: "14479", sou: "114477", honors: "1");
            AreEqual(2, CalculateShanten(tiles));
        }
        ...
        public void ShantenNumberAndKokushimusou()
        {
            ...
            tiles = TileIds.Parse(man: "19", pin: "129", sou: "129", honors: "123456");
            AreEqual(1, CalculateShanten(tiles));

            tiles = TileIds.Parse(man: "129", pin: "129", sou: "129", honors: "12345");
            AreEqual(2, CalculateShanten(tiles));
        }
        ...
        {
            var tiles = TileIds.Parse(pin: "222567", sou: "44467778");
            AreEqual(AGARI_STATE, CalculateShanten(tiles));
            ...
            tiles = TileIds.Parse(man: "345", pin: "222", sou: "23455567");
