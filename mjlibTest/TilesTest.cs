...
namespace mjlibTest
{
    ...
    public class TilesTest
    {
        ...
        {
            var expected = new Tiles136(new List<int>
            {
        ...
        public void StringToTiles136()
        {
            ...
            var actual = Tiles136.Parse(man: "19", pin: "19", sou: "19", honors: "1234567");
        ...
        {
            var actual = new Tiles136(new List<int>
            {
                3,4,5,6
            }).FindTileKindInTiles136(new TileKind(0));
            Assert.AreEqual(3, actual.Value);

            actual = new Tiles136(new List<int>
            {
                3, 4, 134, 135
        ...
        {
            var tiles = Tiles136.Parse(man: "2244", pin: "333r67", sou: "44", hasAkaDora: true);
            Assert.IsTrue(tiles.Select(t => t.Value).Contains(FIVE_RED_PIN));

            tiles = Tiles136.Parse(man: "2244", pin: "333067", sou: "44", hasAkaDora: true);
            Assert.IsTrue(tiles.Select(t => t.Value).Contains(FIVE_RED_PIN));
        }
        ...
        public void OneLineStringToTiles136()
        {
            ...
            var tiles = Tiles136.Parse(str: initialString);
        ...
        {
            var initialString = "789m456p555s11222z";
            var tiles = TilesSet.Parse(str: initialString);
