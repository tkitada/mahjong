...
namespace mjlibTest
{
    ...
    public class AgariTest
    {
        ...
        {
            var tiles = TileIds.Parse(man: "33", pin: "123", sou: "123456789");
            IsTrue(IsAgari(tiles));

            tiles = TileIds.Parse(pin: "11123", sou: "123456789");
            IsTrue(IsAgari(tiles));

            tiles = TileIds.Parse(sou: "123456789", honors: "11777");
            IsTrue(IsAgari(tiles));

            tiles = TileIds.Parse(sou: "12345556778899");
            IsTrue(IsAgari(tiles));

            tiles = TileIds.Parse(sou: "11123456788999");
            IsTrue(IsAgari(tiles));

            tiles = TileIds.Parse(man: "345", pin: "789", sou: "233334", honors: "55");
            IsTrue(IsAgari(tiles));
        }
        ...
        {
            var tiles = TileIds.Parse(man: "199", pin: "19", sou: "19", honors: "1234567");
            IsTrue(IsAgari(tiles));

            tiles = TileIds.Parse(man: "19", pin: "19", sou: "19", honors: "11234567");
            IsTrue(IsAgari(tiles));

            tiles = TileIds.Parse(man: "19", pin: "19", sou: "19", honors: "12345677");
            IsTrue(IsAgari(tiles));

            tiles = TileIds.Parse(man: "19", pin: "19", sou: "129", honors: "1234567");
            IsFalse(IsAgari(tiles));

            tiles = TileIds.Parse(man: "19", pin: "19", sou: "19", honors: "11134567");
            IsFalse(IsAgari(tiles));
        }
